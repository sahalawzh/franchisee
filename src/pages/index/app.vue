    ...
    <el-row class="panel-box">
      <el-col :span="8">
        <div
          class="panel-item"
          @click="handleToPage"
          :class="{ 'panel-item__hover2': mask_active === 1 }"
          @mouseover="handleEnter(1)"
          @mouseleave="handleLeave(1)"
        >
          <div class="panel-title panel-title__one">3D打印功能性定制鞋垫</div>
          <div class="panel-content">
            <el-button class="panel-shape" v-if="isLogin" type="primary"
              >我的足型报告<i class="el-icon-right"></i
            ></el-button>
            ...
            <div class="statistics-box">
              ...
              <div class="statistics-box__desc">
                有<span class="underline"
                  ><span class="underline-num">65</span>%以上人</span
                >群有不同程度的足部问题引起的足、腰腿疼等症状。
              </div>
            </div>
          </div>
      ...
      <el-col :span="8">
        <div
          class="panel-item"
          @click="handleToPage"
          :class="{ 'panel-item__hover2': mask_active === 2 }"
        ...
        >
          <div class="panel-item__logo">
            <img
              v-if="mask_active === 2"
              src="../../assets/common/logo_mask.png"
              alt=""
            />
      ...
      <el-col :span="8">
        <div
          ...
          :class="{ 'panel-item__hover2': mask_active === 3 }"
        ...
        >
          ...
          <div class="panel-content">
            <p>
              兰湾足行邀您创业同行，共享经济，利他原则，<span
                class="stress-text"
                >我们承诺<span class="stress-text__big">90</span
                >%利润让利给您</span
              >，我们承诺一年内达不到市场应有的成果，我们全额退回投资资金。
            </p>
          </div>
  ...
  .panel-box {
    .panel-item {
      ...
      &__mask {
        ...
        width: 100%;
        height: 100%;
        background: rgba(18, 79, 174, 0.83);
      }
      .panel-title {

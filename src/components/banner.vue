        ...
        <div class="shape-wrap">
          <el-col :span="9"
            ...
            <div class="experience-btn">
              <el-link @click="handleExperience">{{ isLogin ? '定制我的专属鞋垫' : '立即体验' }}<i class="el-icon-right"></i></el-link>
            </div>
          </el-col>
          <el-col :span="6"
                  :offset="6">
            <div>
              <el-link class="entrance-btn"
                       @click="handleFranchisees">{{ role === 3 ? '进入加盟商后台' : '我要做加盟商' }}</el-link>
            </div>
            <div v-if="!isLogin">
              <el-link class="entrance-btn"
                       @click="handleToLogin">查看我的脚型数据</el-link>
            </div>
            <el-link class="entrance-btn"
                     href="nearby.html">查看测量点</el-link>
          </el-col>
        </div>
      </el-row>
